function varargout = Main_System(varargin)
% MAIN_SYSTEM MATLAB code for Main_System.fig
%      MAIN_SYSTEM, by itself, creates a new MAIN_SYSTEM or raises the existing
%      singleton*.
%
%      H = MAIN_SYSTEM returns the handle to a new MAIN_SYSTEM or the handle to
%      the existing singleton*.
%
%      MAIN_SYSTEM('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in MAIN_SYSTEM.M with the given input arguments.
%
%      MAIN_SYSTEM('Property','Value',...) creates a new MAIN_SYSTEM or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Main_System_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Main_System_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Main_System

% Last Modified by GUIDE v2.5 16-Jan-2015 20:05:37

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Main_System_OpeningFcn, ...
                   'gui_OutputFcn',  @Main_System_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Main_System is made visible.
function Main_System_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Main_System (see VARARGIN)

% Choose default command line output for Main_System
...
% UIWAIT makes Main_System wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = Main_System_OutputFcn(hObject, eventdata, handles) 
