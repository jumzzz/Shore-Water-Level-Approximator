function varargout = Realtime_Monitor_System(varargin)
% REALTIME_MONITOR_SYSTEM MATLAB code for Realtime_Monitor_System.fig
%      REALTIME_MONITOR_SYSTEM, by itself, creates a new REALTIME_MONITOR_SYSTEM or raises the existing
%      singleton*.
%
%      H = REALTIME_MONITOR_SYSTEM returns the handle to a new REALTIME_MONITOR_SYSTEM or the handle to
%      the existing singleton*.
%
%      REALTIME_MONITOR_SYSTEM('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in REALTIME_MONITOR_SYSTEM.M with the given input arguments.
%
%      REALTIME_MONITOR_SYSTEM('Property','Value',...) creates a new REALTIME_MONITOR_SYSTEM or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Realtime_Monitor_System_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Realtime_Monitor_System_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Realtime_Monitor_System

% Last Modified by GUIDE v2.5 30-Jan-2015 21:57:53

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Realtime_Monitor_System_OpeningFcn, ...
                   'gui_OutputFcn',  @Realtime_Monitor_System_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Realtime_Monitor_System is made visible.
function Realtime_Monitor_System_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Realtime_Monitor_System (see VARARGIN)

% Choose default command line output for Realtime_Monitor_System
...
% UIWAIT makes Realtime_Monitor_System wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = Realtime_Monitor_System_OutputFcn(hObject, eventdata, handles) 
...
fileID = fopen('D:\MATLAB\bin\Image Processing\Tidal State Recognition System\Port Connection\com_port.txt','w');
...
%         rgb = ycbcr2rgb(ycbcr);
        ...
        rgb = imread('D:\MATLAB\bin\Image Processing\Tidal State Recognition System\Saved Image\1.PNG');
        ...
        filename_orig = generate_filename('D:\MATLAB\bin\Image Processing\Tidal State Recognition System\Saved Image\Original\');
        filename_simplified = generate_filename('D:\MATLAB\bin\Image Processing\Tidal State Recognition System\Saved Image\Simplified\');
        disp(filename_orig);
        disp(filename_simplified);
        path_original = sprintf('D:/MATLAB/bin/Image Processing/Tidal State Recognition System/Saved Image/Original/%s', filename_orig);
        path_simplified = sprintf('D:/MATLAB/bin/Image Processing/Tidal State Recognition System/Saved Image/Simplified/%s', filename_simplified);
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
openfig('Return_To_Main_Real.fig');
